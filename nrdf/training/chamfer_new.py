...
# NOTE: taken from pytorch3d new version
...
def _chamfer_distance_single_direction(
    ...
    cham_x_raw =  cham_x if return_raw else None
    cham_x_raw_idx = cham_x_idx if return_raw else None
    if return_raw:
        return None, None, cham_x_raw, cham_x_raw_idx
    ...
    return cham_dist, cham_normals, cham_x_raw, cham_x_raw_idx
...
def chamfer_distance(
    ...
    cham_x, cham_norm_x, cham_x_raw, cham_x_raw_idx = _chamfer_distance_single_direction(
        x,
        y,
        x_lengths,
        y_lengths,
    ...
    if single_directional:
        return cham_x, cham_norm_x, cham_x_raw, cham_x_raw_idx
    else:
        cham_y, cham_norm_y, cham_y_raw, cham_y_raw_idx = _chamfer_distance_single_direction(
            y,
            x,
            y_lengths,
            x_lengths,
        ...
        return (
            cham_x + cham_y if not return_raw else None,
            (cham_norm_x + cham_norm_y) if cham_norm_x is not None else None,
            cham_x_raw if cham_x_raw is not None else None, 
            cham_y_raw if cham_y_raw is not None else None,
            cham_x_raw_idx if cham_x_raw is not None else None, 
            cham_y_raw_idx if cham_y_raw is not None else None            
        )